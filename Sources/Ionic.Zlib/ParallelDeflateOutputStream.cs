...
namespace Ionic.Zlib
{
    ...
    internal class ParallelDeflateOutputStream : Stream
    {
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            for(var i=0; i < BuffersPerCore * Environment.ProcessorCount; i++)
        ...
        private void _KickoffWriter()
        {
            ...
            Task.Factory.StartNew(_PerpetualWriterMethod, null);
        }
        ...
        private void _Flush(bool lastInput)
        {
            ...
            var workitem = _pool[_nextToFill % _pc];
            lock(workitem)
            {
